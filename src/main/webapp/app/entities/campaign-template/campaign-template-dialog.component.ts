...
import { CampaignTemplateCancelDialogComponent } from './campaign-template-cancel-dialog.component';
...
export class CampaignTemplateDialogComponent implements OnInit, OnDestroy {
    ...
    createForm() {
        ...
        this.campaignTemplateGroupCreationForm = this.fb.group({
            ...
            startDate: (this.campaignTemplate.sendImmediately || !this.campaignTemplate.startDate) ? todayDt : this.campaignTemplate.startDate,
            ...
            recurrenceEndDate: (this.campaignTemplate.sendImmediately || !this.campaignTemplate.recurrenceEndDate) ? todayDt : this.campaignTemplate.recurrenceEndDate,
        ...
        this.addCampaignTemplateNameValidator();
        this.addTimeControl();
    ...
    addCampaignTemplateNameValidator(){
        this.nameRegEx = /^[\s\w.-]*$/;
        this.spaceRepRegEx = /^[\s]*$/;
        this.campaignTemplateGroupCreationForm.addControl('campaignName', new FormControl(null, (c: FormControl) => {
            let value = c.value || '';
